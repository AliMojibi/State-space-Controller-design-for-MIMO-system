function dx = observed_system_dynamics(t, x, K,K_o,C,L,g,m,m_0, u_f)
    dx = zeros(size(x));
    ...
    A_h = A_non_lin(L,g,m,m_0,tau,theta_1_h,theta_2_h,theta_1_dot_h,theta_2_dot_h,u);
    B_h = B_non_lin(L,m,m_0,theta_1_h,theta_2_h);
